            ...
            return new[] {
                new RouteDescriptor {
                 ...
                 new RouteDescriptor {
                    Priority = 5,
                    Route = new Route(
                        "Transactions/{controller}/{action}/{id}/{ref}/{verb}",
                        new RouteValueDictionary {
                            {"area", "EXPEDIT.Transactions"},
                            {"controller", "User"}                            
                        },
                ...
                new RouteDescriptor {
                 ...
                 new RouteDescriptor {
                    Priority = 5,
                    Route = new Route(
                        "Store/{controller}/{action}/{id}/{ref}",
                        new RouteValueDictionary {
                            {"area", "EXPEDIT.Transactions"},
                            {"controller", "User"}                            
                        },
                 ...
                 new RouteDescriptor {
                    Priority = 5,
                    Route = new Route(
                        "Store/{controller}/{action}/{id}/{ref}/{verb}",
                        new RouteValueDictionary {
                            {"area", "EXPEDIT.Transactions"},
                            {"controller", "User"}                            
                        },
                ...
                new RouteDescriptor {
                 ...
                 new RouteDescriptor {
                    Priority = 5,
                    Route = new Route(
                        "Products/{controller}/{action}/{id}/{ref}",
                        new RouteValueDictionary {
                            {"area", "EXPEDIT.Transactions"},
                            {"controller", "User"}                            
                        },
                 ...
                 new RouteDescriptor {
                    Priority = 5,
                    Route = new Route(
                        "Products/{controller}/{action}/{id}/{ref}/{verb}",
                        new RouteValueDictionary {
                            {"area", "EXPEDIT.Transactions"},
                            {"controller", "User"}                            
                        },
